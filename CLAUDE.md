...
位于 `opencode/superpowers/skills/` 目录，每个技能包含：
...
`skills/` 目录包含 300+ 个精选技能，按功能分类：

- **图表与可视化**：excalidraw、drawio、mermaid、pretty-mermaid、smart-illustrator
- **浏览器自动化**：agent-browser
- **代码与开发工具**：git-commit、repo2skill、skill-creator、simplify
- **文本处理**：humanizer-z
- **PPT/Office**：pptx、ppt-generation
- **科研相关**：read-arxiv-paper、paper-analyzer、ljg-xray-paper
- **技能发现与管理**：find-skills、claudeception

完整列表参见 `skills/README.md`。
...
- `opencode/SISYPHUS_MODES.md` - Sisyphus 工作模式配置
- `opencode/AGENTS.md` - AI 行为准则和开发规范
- `opencode/superpowers/README.md` - Superpowers 官方文档

### 技能仓库
- `skills/README.md` - 技能仓库完整清单和安装指南

### 工具脚本
- `script/README.md` - 同步脚本详细文档

### 模板与插件
- `prompt/AGENTS.MD/` - Agent 配置模板（多语言版本）
- `prompt/SUCCESSOR.MD/` - 会话交接模板（用于上下文传递）
- `plugin/README.md` - AI Agent 工程范式深度解析
