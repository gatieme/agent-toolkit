...
| [Entroly](https://github.com/juyterman1000/entroly) | 一个为 AI 编码工具提供全代码库上下文的工具, 通过压缩技术减少 70-95% 的令牌成本, 同时确保 AI 能够看到完整的代码库. 核心功能包括代码库索引、信息密度评分、数学优化的文件选择、分层压缩、自学习循环和联邦群体学习.  | 适用于与 Claude、Cursor、Copilot、Codex、MiniMax 等 AI 编码工具集成, 任何规模的项目, 特别适合希望降低 AI API 成本、提高 AI 回答准确性、减少开发者修复 AI 错误时间的团队.  | ⭐⭐⭐ | 241 |
