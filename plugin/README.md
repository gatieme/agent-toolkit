...
| [desktop-cc-gui](https://github.com/zhukunpenglinyutong/desktop-cc-gui) | 为专业开发者设计的 Cursor 替代方案, 专注于开发者体验, 目标是构建 100% 开源和透明的下一代 VibeCoding 编辑器, 基于 CodexMonitor 构建. [官网](https://www.mossx.ai) | Claude Code、Codex CLI、OpenCode CLI、Gemini CLI | ⭐ | 1563 |
